...
4. 해당 내용을 다시 json.loads()를 이용해 파이.썬 객체로 변환
...
#       .....(경로)/.conf-secret/settings_local.json
#            이 출력되어야 함
...
# 루트 폴더의 바로 아래 .conf폴더 (youtube/.conf-secret)
path_dir_conf = os.path.join(path_dir_youtube, '.conf-secret')
print('path_dir_conf : \n%s' % path_dir_conf)
